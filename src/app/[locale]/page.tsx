...
export default function HomePage() {
  ...
  const hiw = useTranslations("HowItWorksPreview");
    ...
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
          ...
          >
            <span className="text-white">{hero("headlineDesign")}</span>{" "}
            <span className="text-gradient">{hero("headlinePrint")}</span>{" "}
            <span className="text-white">{hero("headlineProfit")}</span>
          </motion.h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
              <span className="text-gradient">{trending("heading")}</span> 🔥
            </h2>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-10">
            {(["all", "apparel", "mugs", "posters", "phoneCases", "y2k", "anime", "retro"] as const).map((tagKey, idx) => (
              <button
                key={tagKey}
      ...
      <section className="py-20 px-4 relative">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
              {hiw("heading")} <span className="text-gradient">{hiw("headingHighlight")}</span>
            </h2>
            <p className="text-gray-400 max-w-lg mx-auto">
              {hiw("subtext")}
            </p>
            ...
            {(["s1", "s2", "s3", "s4"] as const).map((key, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-semibold text-white mb-1">{hiw(`steps.${key}.title`)}</h3>
                  <p className="text-sm text-gray-400">{hiw(`steps.${key}.desc`)}</p>
                </motion.div>
              );
            })}
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
              {testimonials("heading")} <span className="text-gradient">{testimonials("headingHighlight")}</span> 💜
            </h2>
            <p className="text-gray-400 max-w-lg mx-auto">
      ...
      <section className="py-20 px-4 relative">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
            {cta("heading")}{" "}
            <span className="text-gradient">{cta("headingHighlight")}</span>
          </h2>
